            ...
            <div class="col-md-4">
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="col-md-12">
                            <?php if (get_order_status($data->order_status, $data->payment_method) != "Selesai") { ?>
                                <div class="card card-primary">
                                    <div class="card-header">
                                        <h5 class="card-heading">Rekening Tujuan</h5>
                                    </div>
                                    <div class="card-body">
                                        <p><b>Silahkan melakukan transfer pembayaran pada rekening berikut:</b></p>
                                        <table class="table table-hover table-striped table-hover">
                                            <thead>
                                                <th>Nama Bank</th>
                                                <th>Atas Nama</th>
