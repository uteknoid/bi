                    ...
                    <tr class="text-center cart-<?php echo $item['rowid']; ?>">
                      ...
                      <td class="quantity">
                        <div class="input-group mb-3">
                          <input type="hidden"value="<?php echo $item['price']; ?>" id="harga">
                          <input type="text" name="quantity[<?php echo $item['rowid']; ?>]" class="quantity form-control input-number" value="<?php echo $item['qty']; ?>" min="1" max="100" id="quantity">
                        </div>
                      </td>

                      <td class="total">
                        <input id="total" style="border: none; color: black;" type="text" value="Rp. <?php echo format_rupiah($item['subtotal']); ?>" disabled>
                      </td>
                      </tr><!-- END TR-->
                    <?php endforeach; ?>
                  </tbody>
